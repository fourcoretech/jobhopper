...
class ResumeScoringServiceTest {
    ...
    void setUp() {
        ...
        resumeScoringService = new ResumeScoringService(openAIService);
    }
    ...
    void testAnalyzeResume_Success() {
        ...
        String result = resumeScoringService.analyzeResume(resumeText);
    ...
    void testAnalyzeResume_Exception() {
        ...
        assertThrows(OpenAIException.class, () ->
                resumeScoringService.analyzeResume(resumeText));
        verify(openAIService, times(1)).callGPT(anyString());
    }
}
