...
public class ExceptionHandlerConfig {
    ...
    @ExceptionHandler({InterviewPrepException.class})
    public static ResponseEntity<String> interviewPrepException(InterviewPrepException interviewPrepException) {
        log.error(interviewPrepException.getErrorMessage());
        return ResponseEntity
                .status(interviewPrepException.getStatusCode())
                .body(interviewPrepException.getErrorMessage());
    }
    ...
    public static ResponseEntity<String> resumeException(ResumeException resumeException) {
        log.error(resumeException.getErrorMessage());
        return ResponseEntity
                .status(resumeException.getStatusCode())
                .body(resumeException.getErrorMessage());
    }
